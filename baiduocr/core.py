...
class BaiduOcr(object):
    ...
    _TEST_URL = 'http://apis.baidu.com/apistore/idlocr/ocr'
    _ONLINE_URL = 'http://apis.baidu.com/idl_baidu/baiduocrpay/idlocrpaid'
    ...
    def __init__(self, api_key, environment=''):
        ...
        if environment == 'online':
            self.url = self._ONLINE_URL
        else:
            self.url = self._TEST_URL
